...
//customer
                ...
                .requestMatchers("/api/v1/customer/update").permitAll()
...
//designer
                ...
                .requestMatchers("/api/v1/designer/update").permitAll()
                .requestMatchers("/api/v1/designer/delete").hasAuthority("ADMIN")
                .requestMatchers( "/api/v1/designer/customer-id/{customerId}").permitAll()
                .requestMatchers( "/api/v1/designer/get-name/{name}").hasAuthority("CUSTOMER")
                //ORDER
                .requestMatchers("/api/v1/order/get").permitAll()
                .requestMatchers("/api/v1/order/addOrder/{servicesId}").hasAuthority("CUSTOMER")
                .requestMatchers("/api/v1/order/update").permitAll()
                .requestMatchers("/api/v1/order/delete").permitAll()
...
//DESIGNER B
                ...
                .requestMatchers("/api/v1/DB/add").permitAll()
                .requestMatchers("/api/v1/DB/update/{id}").permitAll()
                .requestMatchers("/api/v1/DB/delete/{id}").permitAll()
//Services
                ...
                .requestMatchers("/api/v1/Image/add").permitAll()
...
//RATEorder
                ...
                .requestMatchers("addOrder/{customerId}/{orderId}").permitAll()
